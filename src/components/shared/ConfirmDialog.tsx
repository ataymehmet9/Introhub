...
const StatusIcon = ({ status }: { status: StatusType }) => {
  switch (status) {
    case 'info':
      return (
        <Avatar className="bg-info-subtle text-info" shape="circle">
    ...
    case 'success':
      return (
        <Avatar className="bg-success-subtle text-success" shape="circle">
          <span className="text-2xl">
            <HiCheckCircle />
          </span>
        </Avatar>
    ...
    case 'warning':
      return (
        <Avatar className="text-warning bg-warning-subtle" shape="circle">
          <span className="text-2xl">
            <HiOutlineExclamationCircle />
          </span>
        </Avatar>
    ...
    case 'danger':
      return (
        <Avatar className="text-error bg-error-subtle" shape="circle">
          <span className="text-2xl">
            <HiOutlineExclamation />
          </span>
        </Avatar>
