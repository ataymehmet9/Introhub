...
type DataTableProps<T> = {
  ...
  indeterminateCheckboxChecked?: (row: Array<Row<T>>) => boolean
...
function DataTable<T>(props: DataTableProps<T>) {
  ...
  const [sorting, setSorting] = useState<Array<ColumnSort> | null>(null)
  ...
  const finalColumns: Array<ColumnDef<T>> = useMemo(() => {
  ...
  const table = useReactTable({
    ...
    onSortingChange: (sorter) => {
      setSorting(sorter as Array<ColumnSort>)
    },
    state: {
      sorting: sorting as Array<ColumnSort>,
    },
  })
